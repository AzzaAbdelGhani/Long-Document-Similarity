...
def main():
	...
	#sbert_sim353  = SBERT_WikiSimilarity(dataset_name="wikipediaSimilarity353", saved_embeddings_path="WikiSRS/data/embeddings/wikipediaSimilarity353_embeddings.pkl")
	#print("\nRunning SBERT on WikiSRS_similarity dataset : \n")
	#sbert_wikiSim = SBERT_WikiSimilarity(dataset_name="WikiSRS_similarity", saved_embeddings_path="WikiSRS/data/embeddings/WikiSRS_similarity_embeddings.pkl")
	#print("\nRunning SBERT on WikiSRS_relatedness dataset : \n")
	#sbert_wikiRel = SBERT_WikiSimilarity(dataset_name="WikiSRS_relatedness", saved_embeddings_path="WikiSRS/data/embeddings/WikiSRS_relatedness_embeddings.pkl")
